...
// Message to the person tempted to delete this file when integrating ImGui into their codebase:
...
// If you want to link core ImGui in your shipped builds but want a thorough guarantee that the demo will not be
// linked, you can setup your imconfig.h with #define IMGUI_DISABLE_DEMO_WINDOWS and those functions will be empty.
// In another situation, whenever you have ImGui available you probably want this to be available for reference.
// Thank you,
...
// - We never use any of the helpers/facilities used internally by ImGui, unless available in the public API.
...
// Demonstrate most ImGui features (this is big function!)
// You may execute this function to experiment with the UI and understand what it does.
// You may then search for keywords in the code when you are interested by a specific feature.
void ImGui::ShowDemoWindow(bool* p_open)
{
    // Exceptionally add an extra assert here for people confused about initial ImGui setup
    ...
    // ImGui Apps (accessible from the "Tools" menu)
    ...
    {
        ImGui::Begin("ImGui Style Editor", &show_app_style_editor);
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("The \"Tools\" menu above gives access to: About Box, Style Editor,\n"
                          "and Metrics/Debugger (general purpose ImGui debugging tool).");
        ImGui::Separator();
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Instruct ImGui to render a mouse cursor itself. Note that a mouse cursor rendered via your application GPU rendering path will feel more laggy than hardware cursor, but will be more in sync with your other visuals.\n\nSome desktop applications may use both kinds of cursors (e.g. enable software cursor only when resizing/dragging something).");
...
static void ShowDemoWindowPopups()
{
    ...
    // - Their visibility state (~bool) is held internally by ImGui instead of being held by the programmer as
...
static void ShowDemoWindowMisc()
{
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus"))
    {
        ...
        {
            HelpMarker(
                "The value of io.WantCaptureMouse and io.WantCaptureKeyboard are normally set by ImGui "
                "to instruct your application of how to route inputs. Typically, when a value is true, it means "
                "ImGui wants the corresponding inputs and we expect the underlying application to ignore them.\n\n"
                "The most typical case is: when hovering a window, ImGui set io.WantCaptureMouse to true, "
...
//-----------------------------------------------------------------------------
// [SECTION] About Window / ShowAboutWindow()
// Access from ImGui Demo -> Tools -> About
//-----------------------------------------------------------------------------

void ImGui::ShowAboutWindow(bool* p_open)
{
    if (!ImGui::Begin("About ImGui", p_open, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ImGui::End();
        return;
    }
    IMGUI_DEMO_MARKER("Tools/About ImGui");
    ImGui::Text("ImGui %s", ImGui::GetVersion());
    ImGui::Separator();
    ImGui::Text("By Omar Cornut and all ImGui contributors.");
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // types and ImVec2/ImVec4. ImGui defines overloaded operators but they are internal to imgui.cpp and not
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("BG/FG draw lists"))
        {
            ...
            ImGui::SameLine(); HelpMarker("The Background draw list will be rendered below every ImGui windows.");
            ImGui::Checkbox("Draw in Foreground draw list", &draw_fg);
            ImGui::SameLine(); HelpMarker("The Foreground draw list will be rendered over every ImGui windows.");
